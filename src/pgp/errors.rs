...
macro_rules! unimplemented_err {
    ($e:expr) => {
        return Err($crate::pgp::errors::Error::Unimplemented($e.to_string()))
    };
    ($fmt:expr, $($arg:tt)+) => {
        return Err($crate::pgp::errors::Error::Unimplemented(format!($fmt, $($arg)+)))
    };
}
...
macro_rules! unsupported_err {
    ($e:expr) => {
        return Err($crate::pgp::errors::Error::Unsupported($e.to_string()))
    };
    ($fmt:expr, $($arg:tt)+) => {
        return Err($crate::pgp::errors::Error::Unsupported(format!($fmt, $($arg)+)))
    };
}
...
macro_rules! bail {
    ($e:expr) => {
        return Err($crate::pgp::errors::Error::Message($e.to_string()))
    };
    ($fmt:expr, $($arg:tt)+) => {
        return Err($crate::pgp::errors::Error::Message(format!($fmt, $($arg)+)))
    };
}
...
macro_rules! format_err {
    ($e:expr) => {
        $crate::pgp::errors::Error::Message($e.to_string())
    };
    ($fmt:expr, $($arg:tt)+) => {
        $crate::pgp::errors::Error::Message(format!($fmt, $($arg)+))
    };
}

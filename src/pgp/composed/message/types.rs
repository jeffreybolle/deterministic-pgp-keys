...
use crate::pgp::armor;
use crate::pgp::composed::message::decrypt::*;
use crate::pgp::composed::shared::Deserializable;
use crate::pgp::composed::signed_key::SignedSecretKey;
use crate::pgp::composed::StandaloneSignature;
use crate::pgp::crypto::{HashAlgorithm, SymmetricKeyAlgorithm};
...
mod tests {
    ...
    use crate::pgp::composed::{Deserializable, Message, SignedSecretKey};
    use crate::pgp::crypto::SymmetricKeyAlgorithm;
    use crate::pgp::types::{CompressionAlgorithm, SecretKeyTrait};
